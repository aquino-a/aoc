...
public class ix {
    public static void main(String[] args) throws IOException {
        ...
        var path = arguments.SetText(0, "kr/aquino/aoc/ix/input.txt");
        var number = Integer.parseInt(arguments.SetText(1, "25"));
        BiFunction<Integer, Long[], Long> func = arguments.SetText(2, "1").equals("1") ? ix::findAnomaly : ix::findContiguousSet;
