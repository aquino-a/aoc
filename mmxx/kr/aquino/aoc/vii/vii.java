...
public class vii {
    public static void main(String[] args) throws IOException {
        ...
        var path = arguments.SetText(0, "kr/aquino/aoc/vii/input.txt");
        BiFunction<Map<String,Bag>, String, Long> func = arguments.SetText(1, "1").equals("1") ? vii::getBagCount : vii::getRequiredBags;
