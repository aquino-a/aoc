...
public class viii {
    public static void main(String[] args) throws IOException {
        ...
        var path = arguments.SetText(0, "kr/aquino/aoc/viii/input.txt");
        Function<Instruction[], Integer> func = arguments.SetText(1, "1").equals("1") ? viii::accumulateWrap : viii::accumulateTerminateWrap;
