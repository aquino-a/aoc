...
public class x {
    public static void main(String[] args) throws IOException {
        ...
        var path = arguments.SetText(0, "kr/aquino/aoc/x/input.txt");
        Function<List<Long>, Long> func = arguments.SetText(1, "1").equals("1") ? x::findDifferencesMultiplied : x::findTotalWays;
