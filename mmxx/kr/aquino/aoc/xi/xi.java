...
public class xi {
    ...
    public static void main(String[] args) throws IOException {
        ...
        var path = arguments.SetText(0, "kr/aquino/aoc/xi/test/test.txt");
        Function<Integer[][], Integer> func = arguments.SetText(1, "1").equals("1") ?
                xi::findOccupiedSeats : xi::findViewableSeats;
    ...
    private static int findOccupiedSeats(Integer[][] chart) {
        return findSeats(chart, xi::findAdjacentOccupied, 4);
    }

    private static int findViewableSeats(Integer[][] chart){
        return findSeats(chart, xi::findViewableOccupied, 5);
    }
